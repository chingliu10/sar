...
// Serve static files from 'assets' directory with 30-day cache and revalidation
app.use(express.static(path.join(process.cwd(), "assets"), {
  maxAge: "30d",                  // Cache for 30 days
  etag: true,                     // Enable ETag for revalidation
  lastModified: true,             // Enable Last-Modified header for revalidation
...
// Your send mail handler remains the same
